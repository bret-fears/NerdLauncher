...
/**
 * Created by bretfears on 10/28/16.
 */
...
public class NerdLauncherFragment extends Fragment {
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ActivityHolder(View itemView) {
            ...
            mIconView = (ImageView) itemView.findViewById(R.id.app_image);
            mListContainer = itemView.findViewById(R.id.list_container);
            mListContainer.setOnClickListener(this);
        }
